        ...
        <ul className="md:flex space-x-8 items-center hidden md:flex">
          <li>
            <RouterLink to="/sign-in">
              <button className="border-2 border-gray-400 text-white px-4 py-2 w-32 hover:font-bold rounded-md bg-gray-800">
                Sign In
              </button>
            </RouterLink>
          </li>
      ...
      {showMenu && (
        <div className="md:hidden">
          <ul className="flex flex-col mt-4 px-4">
            ...
            <li>
              <RouterLink to="/sign-in">
                <button className="bg-gray-800 text-white border-2 border-gray-400 px-4 py-2 w-100 hover:font-bold rounded">Sign In</button>
              </RouterLink>
            </li>
            <li>
              <RouterLink to="/sign-up">

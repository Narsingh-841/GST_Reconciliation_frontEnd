...
const GSTReconciliationPage = () => {
  ...
  const overlayStyle = {
    ...
    zIndex: 1, // Ensure it's above the background but behind content
  };
  ...
  return (
    <div style={backgroundStyle}>
      ...
      <div style={contentStyle} className="flex flex-col min-h-screen min-w-screen">
        <Navbar />
        <main className="relative flex-grow pt-20 px-4"> {/* Adjust pt-24 to ensure space below Navbar */}
          <header className="text-center mb-12 max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-100 shadow-md">Simplify Your Accounting with Our Advanced Integration</p>
          </header>
